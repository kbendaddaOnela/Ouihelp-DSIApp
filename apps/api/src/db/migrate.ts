...
async function ensureSchemaPatches() {
  ...
  const columnPatches: Array<{ table: string; column: string; ddl: string }> = [
    ...
    { table: 'shared_migrations', column: 'archived', ddl: `ALTER TABLE \`shared_migrations\` ADD COLUMN \`archived\` int NOT NULL DEFAULT 0` },
    { table: 'shared_migrations', column: 'archived_at', ddl: `ALTER TABLE \`shared_migrations\` ADD COLUMN \`archived_at\` timestamp NULL` },
  ...
  const tablePatches: Array<{ table: string; ddl: string }> = [
    ...
    },
    {
      ...
      ddl: `CREATE TABLE \`account_creations\` (
        \`id\` varchar(36) NOT NULL,
        \`first_name\` varchar(255) NOT NULL,
        \`last_name\` varchar(255) NOT NULL,
        \`display_name\` varchar(255) NOT NULL,
        \`onela_upn\` varchar(255) NOT NULL,
        \`goh_upn\` varchar(255) NOT NULL,
        \`goh_user_id\` varchar(255),
        \`routing_address\` varchar(255) NOT NULL,
        \`temp_password\` varchar(255),
        \`assignment_type\` enum('Siège','Agence') NOT NULL,
        \`department\` varchar(255),
        \`job_title\` varchar(255),
        ...
        \`city\` varchar(255),
        \`step_create_goh\` enum('pending','running','success','error','skipped') NOT NULL DEFAULT 'pending',
        ...
        \`updated_at\` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
        PRIMARY KEY (\`id\`),
        UNIQUE KEY \`account_creations_goh_upn_unique\` (\`goh_upn\`),
    ...
    {
      table: 'ximi_migrations',
      ddl: `CREATE TABLE \`ximi_migrations\` (
        \`id\` varchar(36) NOT NULL,
        \`label\` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
        \`source_site_url\` varchar(1000) NOT NULL,
        \`source_site_id\` varchar(500) NOT NULL,
        \`source_site_name\` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
        \`source_drive_id\` varchar(500),
        \`source_drive_name\` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
        \`target_site_url\` varchar(1000),
        \`target_site_id\` varchar(500),
        \`target_site_name\` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
        \`target_site_alias\` varchar(200),
        \`target_drive_id\` varchar(500),
        \`target_preexisting\` boolean NOT NULL DEFAULT false,
        \`site_status\` enum('pending','running','success','error','skipped') NOT NULL DEFAULT 'pending',
        \`site_error\` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
        \`dynamic_group_name\` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
        \`dynamic_group_id\` varchar(100),
        \`permission_status\` enum('pending','running','success','error','skipped') NOT NULL DEFAULT 'pending',
        \`permission_error\` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
        \`status\` enum('pending','running','paused','success','error') NOT NULL DEFAULT 'pending',
        \`analyze_only\` boolean NOT NULL DEFAULT false,
        \`total_items\` int NOT NULL DEFAULT 0,
        \`migrated_items\` int NOT NULL DEFAULT 0,
        \`updated_items\` int NOT NULL DEFAULT 0,
        \`deleted_items\` int NOT NULL DEFAULT 0,
        \`moved_items\` int NOT NULL DEFAULT 0,
        \`failed_items\` int NOT NULL DEFAULT 0,
        \`skipped_items\` int NOT NULL DEFAULT 0,
        \`scanned_items\` int NOT NULL DEFAULT 0,
        \`total_bytes\` bigint NOT NULL DEFAULT 0,
        ...
        \`updated_at\` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
        PRIMARY KEY (\`id\`),
        KEY \`ximi_migrations_source_idx\` (\`source_site_id\`)
      )`,
    },
    {
      table: 'ximi_migrated_items',
      ddl: `CREATE TABLE \`ximi_migrated_items\` (
        \`id\` int NOT NULL AUTO_INCREMENT,
        \`migration_id\` varchar(36) NOT NULL,
        \`sp_item_id\` varchar(500) NOT NULL,
        \`parent_sp_item_id\` varchar(500),
        ...
        \`is_folder\` boolean NOT NULL DEFAULT false,
        \`size_bytes\` bigint,
        \`target_item_id\` varchar(500),
        \`status\` enum('success','error','skipped','deleted') NOT NULL,
        \`error_details\` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
        \`sp_last_modified\` timestamp NULL,
        \`synced_at\` timestamp NULL,
        ...
        \`created_at\` timestamp NOT NULL DEFAULT (now()),
        PRIMARY KEY (\`id\`),
        UNIQUE KEY \`ximi_migrated_items_unique\` (\`migration_id\`, \`sp_item_id\`),
